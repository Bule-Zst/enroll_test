          ...
          <ul class="nav navbar-nav navbar-right">
            <?php if($_SESSION['login_uid']): ?><li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="<?php echo U('User/newadmin');?>">管理员账号注册</a></li>
...
<div class="container">
  <div class="rows">
	...
	<div class="addregister">
	    ...
	    <form class="form-horizontal" id="registerForm" role="form" method="post" action="<?php echo U('Post/index');?>">
		...
		<table class="table table-hover" id="optionTable">
			...
			<?php $__FOR_START_31938__=0;$__FOR_END_31938__=1;for($i=$__FOR_START_31938__;$i < $__FOR_END_31938__;$i+=1){ ?><tr>
			        <td>
			        	<div class="input-group">
			        	    <span class="input-group-btn">
